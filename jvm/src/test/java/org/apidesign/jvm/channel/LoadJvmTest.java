...
/** Creates an instance of {@link JVM} and performs some tests on it.
 * Please note: <strong>there can be only one HotSpot JVM</strong> per
 * process. Avoid creating another ones.
 */
