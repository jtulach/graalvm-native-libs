 ...
 * Provides a {@link JVM#create factory method} to boot a HotSpot JVM
 * from inside of a GraalVM <em>native image</em> application. Allows
 * one to easily execute a {@code main} method in the other JVM via
 * {@link #executeMain}. See {@link Channel} for more intricate communication
 * between the JVMs.
 * 
 * @see Channel
 */
