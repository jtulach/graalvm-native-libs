 ...
 * {@link JVM#create factory method} to boot a HotSpot JVM from inside of a
 * GraalVM <em>native image</em> application. Allows one to easily execute a
 * {@code main} method in the other JVM via {@link #executeMain}. See
 * {@link Channel} for more intricate communication between the JVMs.
 *
 * @see Channel
 */
public final class JVM {
    ...
    /**
     * Create new JVM. Either HotSpot JVM or natively compiled JVM. Use
     * {@link #executeMain} to launch a main method inside of the JVM. Use
     * {@link Channel#create} to establish a channel to send more intricate
     * messages to the JVM.
     *
     * @param path path where the JDK is installed - either path to the HotSpot
     * JVM directory or direct path to the dynamic library that contains the
